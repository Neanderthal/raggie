...
def upgrade():
    ...
    op.create_index(op.f('ix_vector_documents_vector_store_id'), 'vector_documents', ['vector_store_id'], unique=False)
...
def downgrade():
    ...
    op.create_index(op.f('idx_documents_scope'), 'documents', ['scope_id'], unique=False)
    ...
    op.drop_index(op.f('ix_vector_documents_vector_store_id'), table_name='vector_documents')
